# Generated by Django 4.2.4 on 2024-11-04 13:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('maricho', '0004_listing_description_alter_listing_size'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='listing',
            name='size',
            field=models.PositiveIntegerField(help_text='square metres'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('industry', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='properties', to='maricho.job_category')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='property_profile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
